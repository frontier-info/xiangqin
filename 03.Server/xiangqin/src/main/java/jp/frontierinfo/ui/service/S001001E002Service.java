...
@Service
public class S001001E002Service extends AbstractServiceImpl<S001001E002Input, S001001E001Output>{

	
	@Override
	public S001001E001Output execute(S001001E002Input input) throws BusinessException {
		S001001E001Output output = new S001001E001Output();
		System.out.println("Here you Come");
		System.out.println(input.getMobile());
		int count = t01UserLoginInfoAccess.userExistByMobile(input.getMobile());
		if(count == 0) {
			// ユーザーが存在しない
			throw new BusinessException("ユーザーが存在しない");
		}
		T01UserLoginInfo userLoginInfo = t01UserLoginInfoAccess.loginVerifyWithMobile(input.getMobile(), SHA256Util.getSHA256(input.getPassword()));
